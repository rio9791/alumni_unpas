class Accounts::JobsController < Accounts::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @job.save
        format.html { redirect_to accounts_jobs_path, notice: 'Job was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @job.update(job_params)
        format.html { redirect_to accounts_jobs_path, notice: 'Job was successfully updated.' }
  ...
  def destroy
    @job.destroy
    respond_to do |format|
      format.html { redirect_to accounts_jobs_path, notice: 'Job was successfully destroyed.' }
